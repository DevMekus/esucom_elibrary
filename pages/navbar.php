  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex align-center" role="search">
        ...
        <button class="btn btn-sm btn-primary me-2" type="submit">Search</button>
        <a  href="<?= BASE_URL ?>secure/resources/index" class="btn btn-sm btn-primary auth-btn">E-Resource →</a>
